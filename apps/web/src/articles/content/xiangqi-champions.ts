...
// One champion, one game, in the order they first won the title. Every game
// comes from the companion study and is generated by
// scripts/study-chapter-to-article.mjs, so the study is the single source of
// truth for the moves and the engine annotations and this file carries no second
