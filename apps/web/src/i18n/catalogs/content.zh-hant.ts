...
export const ZH_HANT_CONTENT = {
  ...
  'faq.libraryAnswer':
    '三個來源：我們自己重新錄入的公有領域古譜、經主辦方同意轉播的比賽，以及在本站下的對局。我們不轉載其他網站的棋譜庫。別處有規模很大的象棋資料庫，複製過來並不難。那些是建庫的人的成果，所以我們先徵求同意。這樣棋譜庫會比原本可以達到的規模小，但裡面每一局的來源都說得清楚。',
  'faq.libraryExplorer':
  ...
  'patron.heroTitle': '幫 Mistboard 繼續成長。',
  'patron.heroSubtitle': '沒有廣告，沒有付費變強。只是一個你可以出手讓它活下去的獨立專案。',
  ...
  'patron.faqPerkAnswer':
    '贊助換來的是一份認可，不是功能權限。核心的對弈與學習功能始終免費。今後可能會有單獨收費的工具或產品。',
