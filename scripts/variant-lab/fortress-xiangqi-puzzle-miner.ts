...
//   node_modules/.bin/tsx scripts/variant-lab/fortress-xiangqi-puzzle-miner.ts --random-games 400 --emit-module > packages/game/src/puzzles-fortress-xiangqi-mined.ts
...
function renderCorpusModule(candidates: MinedCandidate[]): string {
  const header = `// Generated by the Fortress Xiangqi mate-puzzle miner
...
Options:
  ...
  --emit-module           Print a ready-to-paste puzzles-fortress-xiangqi-mined.ts module.
